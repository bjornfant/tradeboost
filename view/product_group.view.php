						...
						<form action="" method="get">
							<div class="form-group">
								 <div class="row">
		    						...
		    						<div class="col-12"><?php echo $options_product_group; ?></div>
    					...
    					<div class="col-12 pl-2"> 
		    				...
		    				<form name="sorting" id="sorting" method="get">		    				
	    						<div class="form-group row">
	    							...
	    							<label for="sort" class="col-12 col-md-2 offset-md-5 col-form-label text-right"><?php echo $translation[$page_language]['sort_by']; ?></label>
