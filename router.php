...
Route::add('/country/([A-Za-z0-9\-\_]+)', function($country_id) {
  include BASE_DIR . '/controller/product_list_country.php';
});
...
Route::add('/search(.*?)', function() {
  include BASE_DIR . '/controller/search.php';
});
...
Route::add('/gifts', function() {
  include BASE_DIR . '/controller/gifts.php';
});
Route::add('/how-to-sell-gold', function() {
  include BASE_DIR . '/controller/sales_information.php';
});
Route::add('/about', function() {
  include BASE_DIR . '/controller/about.php';
});
Route::add('/privacy', function() {
  include BASE_DIR . '/controller/privacy.php';
});
Route::add('/faq_coin', function() {
  include BASE_DIR . '/controller/faq_coin.php';
});
Route::add('/blog/([A-Za-z0-9\-\_]+)/([A-Za-z0-9\-\_]+)', function($blog_post_id,$blog_post_url) {
  include BASE_DIR . '/controller/blog.php';
});
Route::add('/blog', function() {
  include BASE_DIR . '/controller/blog.php';
});
Route::add('/translate', function() {
  include BASE_DIR . '/controller/translate.php';
});
...
Route::add('/font/([A-Za-z0-9\-\_]+)', function() {
  header('Content-Type: text/css');
  include BASE_DIR . '/view/css/base.css.php';
});
